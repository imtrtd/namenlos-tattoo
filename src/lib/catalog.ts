...
export const FLASH: FlashItem[] = [
  {
    id: "d01",
    img: "/images/ready/fineline-botanical.jpg",
    title: "Fine stem",
    style: "Fine line",
    price: "80€",
    status: "available",
  ...
  {
    id: "d02",
    img: "/images/ready/fineline-motif.jpg",
    title: "Geometry",
    style: "Fine line",
    price: "70€",
    status: "available",
  ...
  {
    id: "d03",
    img: "/images/ready/graphic-skull.jpg",
    title: "Hard skull",
    style: "Graphic",
    price: "100€",
    status: "reserved",
  ...
  {
    id: "d04",
    img: "/images/ready/graphic-dagger.jpg",
    title: "Dagger rose",
    style: "Graphic",
    price: "95€",
    status: "available",
  ...
  {
    id: "d05",
    img: "/images/ready/lettering-gothic.jpg",
    title: "Gothic PAIN",
    style: "Lettering",
    price: "90€",
    status: "available",
  ...
  {
    id: "d06",
    img: "/images/ready/lettering-script.jpg",
    title: "Script fuel",
    style: "Lettering",
    price: "85€",
    status: "ordered",
  ...
  {
    id: "d07",
    img: "/images/ready/design-botanical.jpg",
    title: "Botanical line",
    style: "Fine line",
    price: "75€",
    status: "available",
    desc: {
      en: "Botanical clean line.",
      de: "Botanik, klare Linie.",
      ru: "Ботаника, чистая линия.",
      uk: "Ботаніка, чиста лінія.",
    },
  },
  {
    id: "d08",
    img: "/images/ready/design-geometry.jpg",
    title: "Hard geometry",
    style: "Graphic",
    price: "90€",
    status: "available",
    desc: {
      en: "Geometry blackwork.",
      de: "Geometrie Blackwork.",
      ru: "Геометрия, blackwork.",
      uk: "Геометрія, blackwork.",
    },
  },
  {
    id: "d09",
    img: "/images/ready/design-skull.jpg",
    title: "Punk skull",
    style: "Graphic",
    price: "110€",
    status: "available",
  ...
  {
    id: "d10",
    img: "/images/ready/design-lettering-art.jpg",
    title: "ART mark",
    style: "Lettering",
    price: "80€",
    status: "available",
    desc: {
      en: "Word ART, ornamental.",
      de: "Wort ART, ornamental.",
      ru: "Слово ART, ornamental.",
      uk: "Слово ART, ornamental.",
    },
  },
  {
    id: "d11",
    img: "/images/ready/design-dagger-rose.jpg",
  ...
  {
    id: "d12",
    img: "/images/ready/design-moth.jpg",
    title: "Night moth",
    style: "Fine line",
    price: "85€",
    status: "available",
  ...
  {
    id: "d13",
    img: "/images/ready/design-snake.jpg",
    title: "Coil snake",
    style: "Blackwork",
    price: "120€",
    status: "reserved",
  ...
  {
    id: "d14",
    img: "/images/ready/design-sigil.jpg",
    title: "Sigil mark",
    style: "Cybersigilism",
    price: "95€",
    status: "available",
  ...
  {
    id: "d15",
    img: "/images/ready/design-mandala.jpg",
    title: "Half mandala",
    style: "Ornamental",
    price: "105€",
    status: "available",
  ...
  {
    id: "d16",
    img: "/images/ready/design-chain.jpg",
    title: "Broken chain",
    style: "Graphic",
    price: "80€",
    status: "available",
    desc: {
      en: "Chain, graphic punk.",
      de: "Kette, graphic punk.",
      ru: "Цепь, graphic punk.",
      uk: "Ланцюг, graphic punk.",
    },
  },
  {
    id: "d17",
    img: "/images/ready/design-moon-dagger.jpg",
    title: "Moon dagger",
    style: "Gothic",
    price: "90€",
    status: "available",
    desc: {
      en: "Moon and dagger, gothic line.",
      de: "Mond und Dolch, gothic.",
      ru: "Луна и кинжал, gothic line.",
      uk: "Місяць і кинджал, gothic.",
    },
  },
  {
    id: "d18",
    img: "/images/ready/design-web.jpg",
    title: "Corner web",
    style: "Traditional",
    price: "70€",
    status: "ordered",
    desc: {
      en: "Web corner piece. Ordered.",
      de: "Spinnennetz Corner. Bestellt.",
      ru: "Паутина corner piece. Ordered.",
      uk: "Павутина corner. Ordered.",
    },
  },
];
